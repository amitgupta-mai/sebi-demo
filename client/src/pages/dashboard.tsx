    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex">
        ...
        <main className="flex-1 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <Card>
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-gray-600">Real Shares</p>
                    <p className="text-2xl font-bold text-gray-900">
                      {summaryLoading ? '...' : formatCurrency(portfolioSummary?.realSharesValue || 0)}
                    </p>
            ...
            <Card>
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-gray-600">Tokenized Shares</p>
                    <p className="text-2xl font-bold text-gray-900">
                      {summaryLoading ? '...' : formatCurrency(portfolioSummary?.tokenizedSharesValue || 0)}
                    </p>
                    <p className="text-sm text-gray-500 mt-1">
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-gray-900">
                      {summaryLoading ? '...' : portfolioSummary?.activeOrders || 0}
                    </p>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <div className="space-y-4">
                  ...
                  <Button asChild className="w-full bg-secondary hover:bg-green-700">
                    <Link href="/trading">
          ...
          {/* Holdings Table */}
          <HoldingsTable holdings={holdings} tokenizedShares={tokenizedShares} loading={holdingsLoading || tokensLoading} />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-8">
                        ...
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            <p className="text-sm font-medium text-gray-900">
                              {transaction.transactionType === 'tokenize' ? 'Tokenized' : 
                               transaction.transactionType === 'detokenize' ? 'Converted' :
                               transaction.transactionType === 'trade_buy' ? 'Bought' : 'Sold'} {transaction.company.symbol}
                            </p>
            ...
            <Card>
              <CardContent className="p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-6">NSE Market Overview</h3>
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500">Tata Consultancy</p>
                      </div>
                    </div>
                    <div className="text-right">
                      <p className="text-sm font-medium text-gray-900">₹3,456.80</p>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <p className="text-sm font-medium text-gray-900">RELIANCE</p>
                        <p className="text-xs text-gray-500">Reliance Industries</p>
                      </div>
                    </div>
                    <div className="text-right">
                      <p className="text-sm font-medium text-gray-900">₹2,845.30</p>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <p className="text-sm font-medium text-gray-900">INFY</p>
                        <p className="text-xs text-gray-500">Infosys</p>
                      </div>
                    </div>
                    <div className="text-right">
                      <p className="text-sm font-medium text-gray-900">₹1,678.90</p>
                  ...
                  <div className="mt-6 p-4 bg-blue-50 rounded-lg">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="text-sm font-bold text-gray-900">21,456.30</span>
                    </div>
