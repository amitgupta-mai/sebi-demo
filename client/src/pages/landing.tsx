      ...
      <header className="bg-white shadow-sm border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <Button onClick={() => window.location.href = '/api/login'} className="bg-primary hover:bg-blue-700">
              Login to Continue
            </Button>
          </div>
        </div>
      ...
      <main className="max-w-7xl mx-auto px-6 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
            Tokenize your NSE-listed shares for enhanced liquidity and seamless trading. 
            Convert between real shares and tokens with complete security and transparency.
          </p>
          <Button 
            size="lg" 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          <Card className="text-center">
            ...
            <CardContent>
              <p className="text-gray-600">
                Convert your physical shares into digital tokens for enhanced liquidity and fractional trading.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="text-center">
            ...
            <CardContent>
              <p className="text-gray-600">
                Trade tokenized shares with real-time pricing and advanced order management features.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="text-center">
            ...
            <CardContent>
              <p className="text-gray-600">
                Convert tokens back to physical shares anytime with minimal fees and instant processing.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="text-center">
            ...
            <CardContent>
              <p className="text-gray-600">
                Bank-grade security with full NSE compliance and regulatory oversight for your peace of mind.
              </p>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h4 className="text-lg font-semibold text-gray-900 mb-4">For Individual Investors</h4>
            ...
            <div>
              <h4 className="text-lg font-semibold text-gray-900 mb-4">Platform Benefits</h4>
              <ul className="space-y-3 text-gray-600">
                <li className="flex items-start">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-8">
            Join thousands of investors who have already embraced the future of share trading.
          </p>
          <Button 
            size="lg" 
            onClick={() => window.location.href = '/api/login'}
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center">
            <div className="flex items-center justify-center space-x-3 mb-4">
              ...
              <span className="text-lg font-bold">NSE Tokenization Platform</span>
            </div>
