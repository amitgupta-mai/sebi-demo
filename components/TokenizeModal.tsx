...
export default function TokenizeModal({ isOpen, onClose, holding }: TokenizeModalProps) {
        ...
        <div className="space-y-4">
          {holding && (
            <div className="bg-blue-50 p-4 rounded-lg">
              <h4 className="font-medium text-gray-900 mb-2">Selected Company</h4>
              <div className="text-sm text-gray-600 space-y-1">
                ...
                <div className="flex justify-between">
                  ...
                  <span>{formatCurrency(parseFloat(holding.company.currentPrice))}</span>
                </div>
              </div>
            </div>
          )}
